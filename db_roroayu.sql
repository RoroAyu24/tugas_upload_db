...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2023 at 03:33 AM
...
(1, 'WAHYU', 'JL.JATIKERTO', 'L', 'TKR'),
(2, 'ADIP', 'JL.TALANGAGUNG', 'L', 'TBSM'),
(3, 'PUSPITA', 'JL.PAGAK', 'P', 'TKJ'),
(4, 'ADINTA', 'JL.JENGGOLO', 'P', 'RPL'),
(5, 'AFIKA', 'JL.SUMBERMANJING', 'P', 'TEI');
